...
class EditDiagnoseForm extends ConsumerStatefulWidget {
  final Diagnose diagnose;
  const EditDiagnoseForm({
    super.key,
  ...
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EditDiagnoseFormState();
}

class _EditDiagnoseFormState extends ConsumerState<EditDiagnoseForm> {
  late TextEditingController diagnoseController;
  late TextEditingController recomendationsController;
  TextEditingController medicinesController = TextEditingController();
  late bool isDiagnoseKnown;
  late bool isNeedMedicalHealing;
  ...
  void initState() {
    super.initState();
    diagnoseController = TextEditingController(text: widget.diagnose.diagnose);
    recomendationsController =
        TextEditingController(text: widget.diagnose.recomendations);
    meds =
        widget.diagnose.medicines.isNotEmpty ? widget.diagnose.medicines : [];
    isDiagnoseKnown = widget.diagnose.diagnose != '' ? true : false;
    isNeedMedicalHealing = widget.diagnose.medicines.isNotEmpty ? true : false;
  }
