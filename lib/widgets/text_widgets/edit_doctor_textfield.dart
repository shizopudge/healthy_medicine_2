...
class EditDoctorTextField extends StatefulWidget {
  final String title;
  final TextEditingController controller;
  final bool isNumber;
  final String? Function(String?)? validator;
  final void Function(String)? onChanged;
  const EditDoctorTextField({
    super.key,
    required this.title,
  ...
  @override
  State<EditDoctorTextField> createState() => _EditDoctorTextFieldState();
}

class _EditDoctorTextFieldState extends State<EditDoctorTextField> {
  @override
